...
exports.MeetingEmployee =  async (req, res) => {
  ...
  exports.getAllMeetings = async (req, res) => {
    try {
      ...
      res.status(200).json({ message: " Get All Meetings retrieved successfully", meetings });
    } catch (error) {
  ...
  try {
    ...
    res.status(200).json({ message: " Get Data Id Meeting retrieved successfully", meeting });
  } catch (error) {
